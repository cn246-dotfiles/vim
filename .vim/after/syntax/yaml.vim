" Copied from the vim-yaml plugin
" https://github.com/stephpy/vim-yaml/blob/master/after/syntax/yaml.vim

" Fixes the first item in list having incorrect highlighting
" TODO: figure out how to re-color the hyphens in lists
syntax clear yamlBlockCollectionItemStart
